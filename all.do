...
# This expands to:
../data4rflow.py -d Data_X4 -C datafile.props.csv --Projectiles n --EminCN 10.0 --EmaxCN 20. -i Data_X4/*.dat --pops pops-global.xml N15-pops.xml |& tee data4rflow-Data_X4.out
#
