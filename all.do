...
# EXFOR uses N15 to start with, then GNDS uses N15
...
# 
# This expands to
../getX4cn4data.py N15 0.01 | tee getX4cn-N15-above0.01@.out
#
# Read all *.dat files and csv files, to put into big files flow.data and flow.norms
do.dataflow Data_X4/*.dat

# This expands to:
../data4rflow.py -d Data_X4 -p datafile.props.csv --Projectiles n --EminCN 10.0 --EmaxCN 20. -i Data_X4/*.dat --pops pops-global.xml N15-pops.xml |& tee data4rflow-Data_X4.out
#
