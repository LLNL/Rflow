...
# This expands to:
../data4rflow.py -d Data_X4 -p datafile.props.csv --Projectiles H3 --EminCN 0.0  --EmaxCN 15. -i Data_X4/*.dat --pops ../pops-global.xml local-pops.xml |& tee data4rflow-Data_X4.out
#
